	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/projets.php" class="btn btn-default" ><i class="fa fa-folder-open-o fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp; {#menuListeProjets#}</a>
				...
				{if $groupes|@count > 0}
					<table class="table table-striped table-hover">
						...
						{foreach name=groupes item=groupe from=$groupes}
							...
							<tr>
								<td>
									<a href="javascript:Reloader.stopRefresh();xajax_modifGroupe({$groupe.groupe_id});undefined;"><i class="fa fa-pencil fa-lg fa-fw" aria-hidden="true"></i></a>
