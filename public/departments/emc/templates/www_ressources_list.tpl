						...
						<tr>
							...
							<th class="userTabColId">
								{if $order eq "user_id"}
									...
									{/if}
								{else}
									<a href="{$BASE}/ressources_list.php?page=1&order=user_id&by={$by}">
								{/if}
							</th>
							<th>
								{if $order eq "nom"}
									...
									{/if}
								{else}
									<a href="{$BASE}/ressources_list.php?page=1&order=nom&by={$by}">{#ruser_liste_nom#} ({$users|@count})</a>
								{/if}
							</th>
							<th class="wrap d-none d-sm-table-cell d-lg-table-cell">
								{if $order eq "nom_groupe"}
									...
									{/if}
								{else}
									<a href="{$BASE}/ressources_list.php?page=1&order=nom_groupe&by={$by}">{#user_liste_groupe#} ({$equipes|@count})</a>
								{/if}
							</th>
						</tr>
