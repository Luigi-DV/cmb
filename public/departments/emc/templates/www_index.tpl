...
<div class="container">
	<h3 class="text-center">
		{if $smarty.const.CONFIG_SOPLANNING_LOGO != ''}
				<a href="/"><img src="./upload/logo/Applus.png" alt='logo' id="logo" /></a><br />
		{/if}
		{if $smarty.const.CONFIG_SOPLANNING_TITLE neq "SOPlanning"}
	...
	<div class="small-container">
		...
		{else}
			<form action="process/login.php" method="post" class="form-horizontal box" id="formLogin">
				...
				<div class="form-group">
					<div  class="col-12 text-center">
						<input class="col-12 btn btn-primary" style="background-color:#FF6900!important;" type="submit" value="{#loginTxt#}" />
					</div>
				</div>
			</form>
			<div class="hidden form-group text-center">
			...
			<div id="divTranslation">
				...
				<p class="hidden"><small><a href="mailto:support@soplanning.org">{#proposerTrad#}</a></small></p>
			</div>
