...
<form method="POST" action="" target="_blank">
	...
	<div class="form-group row col-md-12 align-items-center">
		<label class="col-form-label col-md-4">{#ressource_team#} :</label>
		<div class="col-md-7">
	...
	<div class="form-group row col-md-12 align-items-center">
		...
		<div class="col-md-5">
			<br />
			<input type="button" value="{#enregistrer#|escape:"html"}" class="btn btn-primary" onClick="xajax_submitFormRessource('{$ressource.ressource_id}', $('#ressource_id').val(), $('#ressource_nom').val(), $('#ressource_groupe_id').val(),$('#ressource_commentaire').val(), $('#ressource_exclusif').is(':checked'))" />
		</div>
	</div>
</form>
<script>
