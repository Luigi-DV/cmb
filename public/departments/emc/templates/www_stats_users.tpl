...
<div class="container">
	...
	<div class="soplanning-box col-md-12 mt-2">
		...
		<br>
			...
			<div class="form-group row col-md-12">
				...
				<label class="hidden" class="col-md-2 col-form-label">{#stats_projets_liste#} :</label>
				<div class="hidden" class="col-md-4">
			...
			<div class="hidden" class="form-group row col-md-12">
	...
	<div class="soplanning-box mt-2">
		<div class="row">
			<div class="col-md-12">
				{foreach from=$listeUsersGraph item=user_graph}
					<img alt="" src="{$BASE}/graphe_users.php?user_graph={$user_graph}"/>
				{/foreach}
			</div>
		</div>
	</div>
