<x-app-layout>
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{route('department.statistics.resources', $department)}}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{__('Resources')}}</a>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-5">
        <livewire:departments.statistics.resources.occupation :department="$department"/>
    </div>
</x-app-layout>
