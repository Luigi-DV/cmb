...
<div class="container-fluid">
	...
	<div class="tab-content">	
		<div class="hidden tab-pane container active" id="droits">
		...
		<div class="tab-pane container fade" id="perso">
			...
			<label class="col-form-label col-md-3">{#user_login_actif#} :</label>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="visible_planning" id="visible_planningNon" value="oui" {if ($user_form.saved eq 0) || ($user_form.visible_planning eq "oui")}checked="checked"{/if}>
					<label class="form-check-label" for="visible_planningNon">{#oui#}</label>
				</div>
			</div>
			<div class="hidden form-group row">
				<label class="hidden col-form-label col-md-3">{#user_notifications#} :</label>
				<div class="form-check form-check-inline">
