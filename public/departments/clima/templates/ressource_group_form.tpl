...
<form method="POST" action="" target="_blank" onsubmit="return false;">
	...
	<div class="col-md-4">
		<br />
		<input type="button" class="btn btn-primary" value="{#enregistrer#|escape:'html'}" onclick="xajax_submitFormUserGroupe('{$groupe.user_groupe_id|escape}', document.getElementById('nom').value, 'ressource');"/>
	</div>
