...
{include file="www_planning_filtre_equi.tpl"}
	{* le planning *}
	<div class="row">
 ...
 $(document).ready(function() {
	...
	// Gestion du filtre Projet
		$("#filtreGroupeProjet").multiselect({
			...
			nameSuffix: 'projet',
			desactivateUrl: 'process/planning_equi.php?desactiverFiltreGroupeProjet=1',
	...
	// Gestion du filtre User
		$("#filtreUser").multiselect({
			...
			noUpdatePlaceholderText:true,
			nameSuffix: 'user',
			desactivateUrl: 'process/planning_equi.php?desactiverFiltreUser=1',
			placeholder: '{/literal}<i class="fa fa-map-pin fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-md-inline-block">&nbsp;{#formChoixUser#}</span>{literal}',
			texts: {
	...
	// Gestion du filtre Users
		$("#filtreGroupeLieu").multiselect({
			...
			desactivateUrl: 'process/planning_equi.php?desactiverFiltreLieu=1',
	...
	// Gestion du filtre Equipment
		$("#filtreGroupeRess1").multiselect({
			selectAll:false,
			noUpdatePlaceholderText:true,
			nameSuffix: 'ressource',
			desactivateUrl: 'process/planning_equi.php?desactiverFiltreRessource=1',
	...
	$('#tabContenuPlanning td.week,#tabContenuPlanning td.weekend,#tabContenuPlanning .cellProject,#tabContenuPlanning .cellProjectAM,#tabContenuPlanning .cellProjectPM').click(function(ev){
	ev.preventDefault();
	if ($(this).hasClass("cellProject") || $(this).hasClass("cellProjectAM") || $(this).hasClass("cellProjectPM"))
		{
		 cellClic(this.id,0);
