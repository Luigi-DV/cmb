		...
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					...
					{/if}
					<a href="javascript:xajax_ajoutProjet('taches');undefined;" class="btn btn-default"><i class="fa fa-plus-square fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuAjouterProjet#}</a>
		...
		<div class="col-md-12">
			<div class="soplanning-box mt-2">
				...
				<div id="taskListGroupeLabel">
					<label class="hidden col-form-label offset-md-2 w100">{#taches_groupeTaches#} :</label>
				</div>
				<div id="taskListGroupeButton">
				<div class="hidden btn-group" data-toggle="buttons-radio">
	...
	<div class="row">
		<div class=" hidden col-md-12">
			<div class="soplanning-box">
					...
					<div class="hidden btn-group" id="dropdownTaskLieuxFilter">
		...
		<div class="col-md-12">
			<div class="soplanning-box">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="statut[]" id="{$statut.status_id}" value="{$statut.status_id}" onclick="javascript:$('#filtreTaches').submit();" {if in_array($statut.status_id, $listeStatuts)}checked="checked"{/if}>
			...
			<div class="soplanning-box mt-2">
				<table class="table table-striped table-hover" id="taskTab">
					<tr>
						...
						<td class="wrap d-none d-md-table-cell d-lg-table-cell" style="color:#746660;">
					...
					{foreach from=$projets item=projet}
						{if $grouperpar eq 'project' }
							{if $projet.groupe_id neq $projetCourant}
								<tr>
								<td colspan="8" class="task-group-head">{$projet.nom_groupe|xss_protect}</td>
							{/if}
						{elseif $grouperpar eq 'status'}
						...
						{/if}
						<tr>
							<td class="pastille-projet" style="background-color:#{$projet.couleur};color:{"#"|cat:$projet.couleur|buttonFontColor}">{$projet.nom}</td>
							<td class="w140">
							...
							<td>
								<div class="pastille-statut tooltipster" style="background-color:#{$projet.statut_couleur}" title="{$projet.status_nom}"></div>
							</td>
							...
							<td class="wrap d-none d-lg-table-cell">
								...
								{else}
									...
									{elseif $projet.duree_details == 'N'}
										{#options_dureeDefautNuit#}
						...
						{if $grouperpar eq 'project' }
							{assign var=projetCourant value=$projet.groupe_id}
						{elseif $grouperpar eq 'status'}
...
$("#filtreGroupeProjet").multiselect({
	...
	placeholder: '{/literal}<span class="d-none d-md-inline-block">&nbsp;{#taches_filtreProjets#}</span>{literal}',
	texts: {
...
$("#filtreUser").multiselect({
	...
	placeholder: '{/literal}<span class="d-none d-md-inline-block">&nbsp;{#formChoixUser#}</span>{literal}',
	texts: {
       selectAll    : '{/literal}{#formFiltreProjetCocherTous#}{literal}',
       unselectAll    : '{/literal}{#formFiltreProjetDecocherTous#}{literal}',
	   disableFilter : '{/literal}{#formFiltreProjetDesactiver#}{literal}',
