...
<div class="container-fluid" style="width:106%;margin-bottom:60px;">
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box mt-2">
				<table class="table table-striped table-hover" id="projectTab">
					...
					<tr>
						<td colspan="20" class="project-group-head" style="width: auto">{#projet_liste_sansGroupes#}</td>
					</tr>
					{assign var=groupeCourant value=""}
					{foreach from=$projets item=projet}
						{if $projet.groupe_id neq $groupeCourant}
							<tr>
							<td colspan="20" class="project-group-head" style="width: auto">{$projet.nom_groupe|xss_protect}</td>
						{/if}
						<tr>
							<td class="w140">
