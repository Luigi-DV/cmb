						...
						{foreach name=ressources item=ressource from=$ressources}
							<tr>
								...
								<td class="wrap d-none d-md-table-cell d-lg-table-cell">
									{if $ressource.ressource_groupe_id == 1 || $ressource.ressource_groupe_id == NULL}
										<div class="pastille-statut tooltipster" style="background-color:#008000;" {*title="Alta"*}></div>
									{else}
										<div class="pastille-statut tooltipster" style="background-color:#FF0000;" {*title="Baixa"*}></div>
									{/if}
								</td>
								<td class="wrap d-none d-md-table-cell d-lg-table-cell">
								...
								<td class="wrap d-none d-md-table-cell d-lg-table-cell">
									{if $ressource.calibrated == 1 || $ressource.calibrated == 2}
										<div class="pastille-statut tooltipster" style="background-color:#008000;" {*title="Calibrat"*}></div>
									{else}
										<div class="pastille-statut tooltipster" style="background-color:#FF0000;" {*title="No Calibrat"*}></div>
									{/if}
								</td>
							</tr>
						{/foreach}
