		...
		<div class="col-md-12 mb-2" id="firstLayer">
			<div class="soplanning-box form-inline pt-1" id="divPlanningDateSelector">
				...
				{* DIV PER ALS PROJECTES NO ASSIGNATS *}
					<div class="btn-group pt-2 tooltipster hidden" id="dropdownNotAssignedProjects" data-original-title="Not Assigned Projects">
						<button class="btn dropdown-toggle btn-default" data-toggle="dropdown"><i class="fa fa-archive fa-lg fa-fw" aria-hidden="true"></i>
				...
				{* DIV POUR CHOIX FILTRE PROJETS *}
					<div class="btn-group pt-2" id="dropdownTaskProjectFilter" data-original-title="Filter Projects">
					...
					<div class="btn-group pt-2 " id="dropdownTaskUserFilter" data-original-title="Filter Resources">
						<form action="process/planning.php" method="POST">
					...
					<div class="btn-group pt-2 " id="dropdownTaskLieuFilter" data-original-title="Filter Users">
						<form action="process/planning.php" method="POST">
					...
					<div class="btn-group pt-2 " id="dropdownTaskRessourceFilter" data-original-title="Filter Equipment">
						<form action="process/planning.php" method="POST">
					...
					<div class="btn-group pt-2 " id="dropdownAdvancedFilter" data-original-title="Filter Status">
						<form action="process/planning.php" method="POST">
					...
					<div class="btn-group pt-2 " id="dropdownLarge" data-original-title="Compact View">
					...
					<div class="btn-group pt-2 " id="searchboxPlanning" data-original-title="{#formFiltreTexte#|escape}">
						<form action="process/planning.php" method="POST">
							<div class="input-group">
								<input type="text" class="form-control input-sm" name="filtreTexte" value="{$filtreTexte|xss_protect}" maxlength="50" id="filtreTexte" style="width: 188px;"/>
				...
				{* DIV PER CREAR MULTIPLES PROJECTES *}
				{if !in_array("tasks_readonly", $user.tabDroits)}
				<div class="btn-group ml-md-1 pt-2" id="btnAddTask">
				<a class="btn btn-info" href="javascript:addPeriode();">
					{if !$smarty.server.HTTP_USER_AGENT|strstr:"MSIE 8.0"}
					     <i>ADD</i>
					{/if}
				</a>
				...
				{* DIV PER ELIMINAR MULTIPLES PROJECTES *}
				{if !in_array("tasks_readonly", $user.tabDroits)}
				<div class="btn-group ml-md-1 pt-2" id="btnAddTask">
				<a class="btn btn-info" href="javascript:removePeriode();">
					{if !$smarty.server.HTTP_USER_AGENT|strstr:"MSIE 8.0"}
					     <i>DELETE</i>
					{/if}
				</a>
				...
				{* DIV PER COPIAR MULTIPLES PROJECTES *}
				{if !in_array("tasks_readonly", $user.tabDroits)}
				<div class="btn-group ml-md-1 pt-2" id="btnAddTask">
				<a class="btn btn-info" href="javascript:copyPeriode();">
					{if !$smarty.server.HTTP_USER_AGENT|strstr:"MSIE 8.0"}
					     <i>COPY</i>
					{/if}
				</a>
				...
				{* DIV PER ENGANXAR MULTIPLES PROJECTES *}
				{if !in_array("tasks_readonly", $user.tabDroits)}
				<div class="btn-group ml-md-1 pt-2" id="btnAddTask">
				<a class="btn btn-info" href="javascript:pasteProject();">
					{if !$smarty.server.HTTP_USER_AGENT|strstr:"MSIE 8.0"}
					     <i>PASTE</i>
					{/if}
				</a>
