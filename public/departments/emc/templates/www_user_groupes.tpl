	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/user_list.php" class="btn btn-default" ><i class="fa fa-list fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuGestionUsers#}</a>
					<a href="javascript:xajax_modifUserGroupe('','user');undefined;" class="btn btn-default"><i class="fa fa-street-view fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuCreerUserGroupe#}</a>
				</div>
			</div>
		</div>
	</div>
							...
							<tr>
								<td class="w40">
								 {if
                                    ...
                                    $groupe.nom neq "Technician AUTO" &&
                                    $groupe.nom neq "Technician IND" &&
                                    $groupe.nom neq "Test Manager AUTO" &&
                                    $groupe.nom neq "Test Manager IND"}
