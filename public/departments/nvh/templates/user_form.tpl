...
<div class="container-fluid">
	<div class="form-group row col-md-12">
			...
			<div class="col-md-4">
				<select id="user_groupe_id" readonly=readonly class="form-control{if $smarty.session.isMobileOrTablet==0} select2{/if}">
					<option value="">- - - - - - - - - - -</option>
					{foreach from=$groupes item=groupe}
						<option value="{$groupe.user_groupe_id}" {if $user_form.user_groupe_id eq $groupe.user_groupe_id || ($user_form.user_groupe_id eq '' && $groupe.type_groupe eq "users")}selected="selected"{/if}>{$groupe.nom|xss_protect}</option>
					{/foreach}
				</select>
			</div>
	</div>
	<div class="form-group row col-md-12">
				...
				<label class="hidden col-form-label col-md-2">{#user_email#} :</label>
				...
				<label class="col-form-label col-md-3">{#user_couleur#} :</label>
				<div>
	...
	<div class="hidden form-group row col-md-12">
		<label class="col-form-label col-md-2">Resource :</label>
		<div class="col-md-4">
			<select id="ressources" readonly=readonly class="form-control{if $smarty.session.isMobileOrTablet==0} select2{/if}">
				<option value="">- - - - - - - - - - -</option>
				{foreach from=$ressources item=ressource}
					<option value="{$ressource.user_id}" {if $user_form.ressource eq $ressource.user_id}selected="selected"{/if}>{$ressource.nom|xss_protect}</option>
				{/foreach}
			</select>
		</div>
	</div>
	<div class="form-group row col-md-12">
	 <ul class="nav nav-tabs">
		<li class="nav-item">
			<a class="hidden nav-link active" data-toggle="tab" href="#droits">{#user_droits_court#}</a>
		</li>
		<li class="nav-item">
			<a class="hidden nav-link" data-toggle="tab" href="#perso">{#user_perso_notif#}</a>
		</li>
	...
	<div class="tab-content">	
		<div class="tab-pane container active" id="droits">
			...
			<div class="row">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="ressources_droit" id="droit7" value="" {if !in_array("ressources_all", $user_form.tabDroits)}checked="checked"{/if}>
						<label class="form-check-label" for="droit7">{#droits_aucunRessources#}</label>
					</div>	
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="ressources_droit" id="ressources_all" value="ressources_all" {if in_array("ressources_all", $user_form.tabDroits)}checked="checked"{/if}>
        ...
        <div class="hidden tab-pane container fade" id="infos">
			<div class="form-group row">
