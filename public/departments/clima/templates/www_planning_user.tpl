...
{include file="www_planning_filtre_user.tpl"}
	{* le planning *}
	<div class="row">
 ...
 $(document).ready(function() {
	...
	// Gestion du filtre Projet
		$("#filtreGroupeProjet").multiselect({
			...
			nameSuffix: 'projet',
			desactivateUrl: 'process/planning_user.php?desactiverFiltreGroupeProjet=1',
	...
	// Gestion du filtre User
		$("#filtreUser").multiselect({
			...
			noUpdatePlaceholderText:true,
			nameSuffix: 'user',
			desactivateUrl: 'process/planning_user.php?desactiverFiltreUser=1',
	...
	// Gestion du filtre Users
		$("#filtreGroupeLieu1").multiselect({
			selectAll:false,
			noUpdatePlaceholderText:true,
			nameSuffix: 'ressource',
			desactivateUrl: 'process/planning_user.php?desactiverFiltreLieu=1',
