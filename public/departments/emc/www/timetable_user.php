...
$sql .= "	WHERE (planning_periode.projet_id = 'timetable' or planning_periode.projet_id = 'holiday') AND planning_periode.projet_id = planning_projet.projet_id and (
			...
			// Planning Jour
				...
				if (isset($joursOccupes[$current_date])) 
				{
					...
					foreach ($joursOccupes[$current_date] as $j) 
					{
						...
						if($jour['projet_id'] == 'timetable') $jour['tooltip']=create_tooltip($jour);
						$jour['location']='timetable';
